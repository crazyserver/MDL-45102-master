...
class oci_native_moodle_database extends moodle_database {
     ...
     * @param mixed $arg to be converted to varchar
     * @param $length maximum string length when converting
     * @return string SQL of the cast to varchar with substr function
     */
